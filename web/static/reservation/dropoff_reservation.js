...
.controller('DropoffReservationCtrl', ['$scope', '$http', 'localStorageService', '$uibModal', function($scope, $http, localStorageService, $uibModal) {
  $scope.tools = [];
  $scope.toolsAdded = [];
  ...
  $scope.removeTool = function(index) {
    ...
    modalInstance.result.then(function (response) {
      // Check to see if the dropoff reservation table should be reset
